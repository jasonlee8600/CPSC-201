...
(define (kg2lb mass)
  (list (inexact->exact (floor (* mass 2.2)))
        (if (equal? 1 (inexact->exact (floor (* mass 2.2)))) 'pound 'pounds)
        (inexact->exact (floor (* (- (* mass 2.2) (floor (* mass 2.2))) 16)))
        (if (equal? 1 (inexact->exact (floor (* (- (* mass 2.2) (floor (* mass 2.2))) 16)))) 'ounce 'ounces)))
